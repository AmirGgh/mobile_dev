  ...
  return (
    <View className="flex-1 bg-gray-100 p-6">
      <View className="bg-white p-6 rounded-2xl shadow-sm mb-6">
        <Text className="text-2xl font-bold text-gray-800">{profile?.full_name || 'מתאמן חדש'}</Text>
        ...
        <View className="flex-row mt-4 p-4 bg-blue-50 rounded-xl">
          ...
          <View className="flex-1 items-center">
            ...
            <Text className="text-blue-400 text-xs">דרגה</Text>
          </View>
        </View>
      </View>
      ...
      >
        <Text className="text-red-600 font-bold">התנתק</Text>
      </TouchableOpacity>
    </View>
  );
}
